 ...
 */
@Service
@BizBeanService(name = "queryStaff",scope = "TaoService",protocol = {ProtocolType.JSON,ProtocolType.XML})
public class QryStaffInfo2 extends AbstractProcessService<StaffBean> {
